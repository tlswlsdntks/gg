...
var (
	...
	MainnetChainConfig = &ChainConfig{
		ChainID:                       big.NewInt(7237), // T e s t
...
type ChainConfig struct {
	...
	TestBlock           *big.Int `json:"testBlock,omitempty"`           // T e s t
...
func (c *ChainConfig) String() string {
	...
	if c.TestBlock != nil {
		banner += fmt.Sprintf(" - T e s t:                     %-8v (https://github.com/ethereum/execution-specs/blob/master/network-upgrades/mainnet-upgrades/shanghai.md)\n", c.TestBlock)
	}
...
// T e s t
func (c *ChainConfig) IsTest(num *big.Int) bool {
	return isForked(c.TestBlock, num)
}
...
func (c *ChainConfig) CheckConfigForkOrder() error {
	...
	for _, cur := range []fork{
		...
		{name: "testBlock", block: c.TestBlock},
	} {
		if lastFork.name != "" {
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, head *big.Int) *ConfigCompatError {
	...
	if isForkIncompatible(c.TestBlock, newcfg.TestBlock, head) {
		return newCompatError("T e s t block", c.TestBlock, newcfg.TestBlock)
	}
	return nil
}
